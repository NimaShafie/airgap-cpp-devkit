...
**v1.3.66** — DevKit Manager is a single pre-compiled Go binary with
...
| [`tools/dev-tools/servy/`](tools/dev-tools/servy/README.md) | Servy 8.9 — Windows service manager (no-op on Linux) | No |
