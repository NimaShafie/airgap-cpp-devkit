...
bash vscode-extensions/bootstrap.sh --verify

# Dry run — show what would be installed without installing
bash vscode-extensions/bootstrap.sh --dry-run
```
...
5. Navigate to `vscode-extensions/vendor/` and select the `.vsix` file

Or via command line:
```bash
code --install-extension vscode-extensions/vendor/ms-vscode.cpptools-extension-pack-1.5.1.vsix
code --install-extension vscode-extensions/vendor/ms-vscode.cpptools-1.30.4-win32-x64.vsix   # Windows
code --install-extension vscode-extensions/vendor/ms-vscode.cpptools-1.30.4-linux-x64.vsix   # Linux
code --install-extension vscode-extensions/vendor/matepek.vscode-catch2-test-adapter-4.22.3.vsix
code --install-extension vscode-extensions/vendor/ms-python.python-2026.5.2026031201-win32-x64.vsix  # Windows
code --install-extension vscode-extensions/vendor/ms-python.python-2026.5.2026031201-linux-x64.vsix  # Linux
```
...
cat vscode-extensions/vendor/ms-vscode.cpptools-1.30.4-win32-x64.vsix.part-{aa,ab} \
    > vscode-extensions/vendor/ms-vscode.cpptools-1.30.4-win32-x64.vsix

# Linux (linux-x64) — 3 parts
cat vscode-extensions/vendor/ms-vscode.cpptools-1.30.4-linux-x64.vsix.part-{aa,ab,ac} \
    > vscode-extensions/vendor/ms-vscode.cpptools-1.30.4-linux-x64.vsix
```
