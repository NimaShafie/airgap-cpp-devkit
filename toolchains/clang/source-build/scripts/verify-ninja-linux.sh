...
BINARY="${REPO_ROOT}/prebuilt-binaries/toolchains/clang/ninja-linux"
DEST="${MODULE_ROOT}/bin/linux/ninja"

echo "============================================================"
echo " toolchains/clang-source-build — Verify ninja (Linux)"
echo "============================================================"
echo ""
echo " Binary: ${BINARY}"
echo ""

EXPECTED=$(awk '/"ninja_linux"/{f=1} f && /"sha256_binary"/{
