...
_banner() {
    ...
    echo ""
    echo "╔══════════════════════════════════════════════════════════════════╗"
    echo "║         toolchains/clang-style-formatter — Tool Verification          ║"
    echo "╚══════════════════════════════════════════════════════════════════╝"
    echo "  Platform : ${OS}"
...
_print_build_guidance_windows() {
    ...
    echo "    bash ${SUBMODULE_ROOT}/../toolchains/clang-source-build/bootstrap.sh" >&2
    echo "" >&2
...
_print_build_guidance() {
    ...
    case "${OS}" in
        ...
        *)
            ...
            echo "  Slow path (~30-60 min): bash ${SUBMODULE_ROOT}/../toolchains/clang-source-build/bootstrap.sh" >&2
            echo "  See: ${DOCS_DIR}/llvm-install-guide.md" >&2
            echo "" >&2
            ;;
    esac
