...
#
#      Windows  ->  targeting a folder called "dev-tools/git-bundle" on your Desktop:
#          REPO_PATH = Path(r"C:\Users\YourName\Desktop\dev-tools/git-bundle")
#
#      Linux    ->  same idea:
#          REPO_PATH = Path.home() / "Desktop" / "dev-tools/git-bundle"
#
