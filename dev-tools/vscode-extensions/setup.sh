...
# Author: Nima Shafie
# =============================================================================
# dev-tools/vscode-extensions/setup.sh
#
# Verifies, reassembles (if needed), and installs all vendored VS Code
# extensions into the locally installed VS Code instance.
#
# USAGE:
#   bash dev-tools/vscode-extensions/setup.sh              # auto-detect platform
#   bash dev-tools/vscode-extensions/setup.sh --dry-run    # verify only, no install
#   bash dev-tools/vscode-extensions/setup.sh --verify     # verify SHA256 only
#
# REQUIREMENTS:
